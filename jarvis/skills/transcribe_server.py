...
try:
    ...
    print("ERROR: Whisper not installed. Please run: pip install openai-whisper torch")
    sys.exit(1)
...
def main():
    ...
    try:
        model = whisper.load_model("base") # base is fast and accurate enough for English commands
        print("READY")
        sys.stdout.flush()
